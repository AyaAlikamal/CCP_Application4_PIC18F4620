...
Std_ReturnType CCP_Compare_Mode_Set_Value(uint_16 compare_value);
...
Std_ReturnType CCP1_CAPTURE_Init(const ccp_t *ccp_obj){
...
Std_ReturnType CCP1_COMPARE_Init(const ccp_t *ccp_obj){
Std_ReturnType ret = (Std_ReturnType)0x01;
if(ccp_obj == ((void*)0)){
ret = (Std_ReturnType)0x00;
}
