...
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/mcal_std_type.h" 1
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/mcal_std_type.h"
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h" 1
# 10 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h"
...
# 10 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h" 2
...
# 11 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h" 2
...
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/std_libraries.h" 2
# 12 "MCAL_Layer/ADC/../../MCAL_Layer/mcal_std_type.h" 2

# 1 "MCAL_Layer/ADC/../../MCAL_Layer/compiler.h" 1
# 10 "MCAL_Layer/ADC/../../MCAL_Layer/compiler.h"
...
# 10 "MCAL_Layer/ADC/../../MCAL_Layer/compiler.h" 2
# 13 "MCAL_Layer/ADC/../../MCAL_Layer/mcal_std_type.h" 2
...
# 1 "MCAL_Layer/ADC/../GPIO/../../../../Embeded-Compiler/pic/include/proc/pic18f4620.h" 1
# 12 "MCAL_Layer/ADC/../GPIO/hal_gpio.h" 2
...
# 44 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
typedef enum{
    LOW = 0,
    HIGH
}logic_t;
...
# 10 "MCAL_Layer/ADC/../interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/ADC/../interrupt/../../../../Embeded-Compiler/pic/include/proc/pic18f4620.h" 1
# 10 "MCAL_Layer/ADC/../interrupt/mcal_interrupt_config.h" 2


# 1 "MCAL_Layer/ADC/../interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_Layer/ADC/../interrupt/mcal_interrupt_config.h" 2
# 50 "MCAL_Layer/ADC/../interrupt/mcal_interrupt_config.h"
typedef enum {
...
# 6 "MCAL_Layer/ADC/hal_adc.c" 2



static void(*ADC_Interrupt_Handular)(void)= ((void*)0);

static __attribute__((inline)) void adc_input_port_configure(adc_channel_select_t channel);
static __attribute__((inline)) void select_result_format(const adc_conf_t *_adc_obj);
static __attribute__((inline)) void select_voltage_reference(const adc_conf_t *_adc_obj);
...
Std_ReturnType ADC_IsConversionDone(const adc_conf_t *_adc_obj, uint_8 *conversion_statues){
Std_ReturnType ret = (Std_ReturnType)0x01;
if((_adc_obj == ((void*)0))|| (conversion_statues == ((void*)0))){
ret = (Std_ReturnType)0x00;
}
else{
...
Std_ReturnType ADC_GetConversion_Result(const adc_conf_t *_adc_obj, adc_result *conversion_result){
Std_ReturnType ret = (Std_ReturnType)0x01;
if((_adc_obj == ((void*)0))|| (conversion_result == ((void*)0))){
ret = (Std_ReturnType)0x00;
}
else{
   if(_adc_obj->result_format == 0x01U){
       *conversion_result = (adc_result)((ADRESH << 8) + ADRESL);
    }
    else if(_adc_obj->result_format == 0x00U){
...
static __attribute__((inline)) void select_voltage_reference(const adc_conf_t *_adc_obj){
    if(_adc_obj->voltage_reference== 0x01U){
    do{ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG0 = 1; }while(0);
    }
    else if(_adc_obj->voltage_reference == 0x00U){
